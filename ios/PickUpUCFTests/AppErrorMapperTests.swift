...
final class AppErrorMapperTests: XCTestCase {
    ...
    func testPreservesTrustedDomainMessages() {
        let cases: [(Error, String)] = [
            ...
            (ReportRepositoryError.reasonTooShort, "Please describe the issue in at least 10 characters."),
            (ReportRepositoryError.reasonTooLong, "Keep your report under 500 characters."),
            (ReportRepositoryError.alreadyReported, "You already reported this session."),
